        ...
        <>
            <style>{`
                ...
                * { box-sizing: border-box; margin: 0; padding: 0; }
                ...
                .field-wrapper:nth-child(3) { animation-delay: 0.35s; }
            ...
            <div className="register-root">
                <div className="register-card">
                    <div className="brand-area">
                        ...
                        <div className="brand-name"><span>Notlarım</span>Kayıt</div>
                    </div>

                    <h1 className="register-heading">Hesap oluştur</h1>
                    <p className="register-sub">Başlamak için birkaç saniye yeterli.</p>
